...
This project demonstrates the use of SQL to analyze workplace safety data and extract meaningful business insights. By applying 

## ✅ Conclusion
This dashboard highlights key performance trends and uncovers areas where the business can improve profitability and efficiency.  

While sales are strong, profitability is inconsistent, indicating opportunities for optimisation in pricing, operations, and customer strategy.
